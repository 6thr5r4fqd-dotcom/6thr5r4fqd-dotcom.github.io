...
tags: [Partido, Estrategia, Gramsci]
---
...
<img class="post-featured-image" src="{{ page.image }}" alt="Imagen del artículo">
...
1. Gramsci, A. *Maquiavelo y Lenin: Notas para una Teoría Política Marxista*. Selección y Prólogo de Osvaldo Fernandez D. (1971).

2. Maquiavelo, N. *El Príncipe*.

3. Proveniente del griego ἦθος. Para efectos del presente texto se entenderá Ethos por el conjunto de valores, costumbres y prácticas, entendidas en el ser y por tanto en la ética que rige la praxis del Partido.

4. Lenin, V. Marx, K. *La comuna de París*. Quimantú editores. (1972).
